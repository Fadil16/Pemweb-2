...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Project Pemweb</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Aditya Rafadilla</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="all/Praktikum 01" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 01</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="all/Praktikum 02" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 02</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="all/Praktikum 03" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 03</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="all/Praktikum 04" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Praktikum 04</p>
                </a>
              </li>
